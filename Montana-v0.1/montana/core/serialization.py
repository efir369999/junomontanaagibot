"""
Ɉ Montana Protocol Serialization Utilities v3.1
...
from montana.constants import BIG_ENDIAN, LITTLE_ENDIAN
...
# ==============================================================================
# Varint Encoding (Compact Variable-Length Integer)
# ==============================================================================

def serialize_varint(value: int) -> bytes:
    """
    Serialize integer as compact variable-length integer.
